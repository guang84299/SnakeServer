...
public class GWebSocketUtils {
    ...
    public static String getWebSocketKeyChallengeResponse(String challenge) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        return GBase64.encodeBytes(hashedVal);
    }
}
